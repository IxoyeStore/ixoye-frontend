    ...
    <section className="max-w-7xl mx-auto px-4 py-16 bg-white">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {shipments.map((item) => (
          <div
            key={item.id}
            className="group bg-white rounded-xl shadow-sm border border-blue-50 hover:shadow-lg transition-all duration-300 flex flex-col"
          >
            {/* IMAGEN DE ENVIO */}
            <div className="aspect-[4/3] bg-blue-50/30 relative overflow-hidden">
              <div className="w-full h-full flex flex-col items-center justify-center border-b border-blue-100 bg-[#f8fafc]">
                <svg
                  className="w-10 h-10 text-[#0055a4] opacity-30 mb-2"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
                ...
                <span className="text-[#0055a4] text-[9px] font-bold uppercase tracking-[0.2em] opacity-40">
                  Evidencia
                </span>
              </div>
            </div>
            ...
            <div className="p-5 flex flex-col flex-grow">
              ...
              <p className="text-[#334155] text-[13px] leading-relaxed italic mb-4 flex-grow">
                {`"${item.comment}"`}
              </p>
              ...
              <div className="pt-3 border-t border-slate-100 flex justify-between items-end">
                <div className="min-w-0">
                  <div className="flex items-center gap-1 font-bold text-[#003366] text-xs">
                ...
                <p className="text-[9px] font-bold text-blue-400 whitespace-nowrap">
