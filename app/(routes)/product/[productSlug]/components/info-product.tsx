        ...
        <div className="p-5 flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2 border-b border-slate-50 pb-3">
            ...
            <div className="grid min-w-0">
              <div className="flex flex-nowrap sm:flex-wrap overflow-x-auto sm:overflow-visible gap-2 pb-2 no-scrollbar">
                {seriesList.length > 0 ? (
                  seriesList.map((serie, idx) => (
                    <span
                      key={idx}
                      className="inline-flex shrink-0 whitespace-nowrap bg-slate-100 text-slate-700 text-[10px] font-black uppercase px-2 py-1 rounded-md border border-slate-200 italic shadow-sm"
                    >
                      {serie}
                    </span>
                  ))
