...
import { X, Search, Target, ChevronRight, ArrowLeft } from "lucide-react";
import { Button } from "@/components/ui/button";
import ProductSort from "@/components/product-sort";
// Importa tu nuevo componente (ajusta la ruta según tu carpeta)
                    ...
                    <div className="flex flex-col gap-3 max-h-80 overflow-y-auto pr-2 custom-scrollbar">
                      {availableBrands.map((brand) => (
                        ...
                        >
                          ...
                          />
                          <span
                            className={`text-xs font-bold uppercase ${selectedBrands.includes(brand) ? "text-slate-900" : "text-slate-400"}`}
                          >
                            {brand}
                          </span>
                        </label>
            ...
            <div className="flex items-end justify-between mb-10 border-b border-slate-100 pb-6">
              <div className="flex flex-col gap-1">
                <div className="flex items-center gap-3">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1.5 px-2.5 py-1 bg-slate-100 hover:bg-red-600 text-slate-500 hover:text-white rounded-md transition-all duration-200 group shadow-sm"
                  >
                    <X
                      size={11}
                      strokeWidth={3}
              ...
              <div className="flex items-center gap-8">
                <div className="text-right border-r border-slate-100 pr-8">
                  <span className="block text-2xl font-light text-slate-400 leading-none">
                ...
                <div className="shrink-0 flex flex-col gap-1">
                  <span className="text-[9px] font-bold text-slate-400 uppercase tracking-tighter text-right mb-1">
                    Ordenar por
                  </span>
                  <ProductSort />
                </div>
